...
export const AddButton: React.FC<{
	...
	const [selectedType, setSelectedType] = React.useState<'icmp' | 'tcp' | 'http'>(preset?.type ?? 'icmp')
			...
			<Dialog.Content>
				...
				<form onSubmit={handleSubmit}>
					<Flex direction="column" justify="end" gap="2" className="font-bold">
						...
						<TextField.Root id="ping_name" name="ping_name" autoComplete="off" defaultValue={defaultValues.name} />
						<label htmlFor="type">{t('ping.type')}</label>
						<SegmentedControl.Root value={selectedType} onValueChange={value => setSelectedType(value as 'icmp' | 'tcp' | 'http')} size="2">
							<SegmentedControl.Item value="icmp">ICMP</SegmentedControl.Item>
						...
						<TextField.Root id="interval" name="interval" type="number" placeholder="60" defaultValue={defaultValues.interval ?? 60} />
