...
import { Search, Grid3X3, Table2, Moon, Sun, SunMoon, CircleUserIcon, Menu, DollarSign, SignalHigh, Link2 } from 'lucide-react'
						...
						<>
							{isMobile ? (
								...
								<>
									...
									<Link to="/latency">
										<Button variant={isLatencyPage ? 'secondary' : 'ghost'} size="sm" className="gap-1" title="延迟监控">
